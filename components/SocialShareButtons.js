...
const SocialShareButtons = ({
  ...
  description,
  image,
  hashtags = ["Shubhhampers", "Gifts", "GiftHampers", "PersonalizedGifts"],
  className = "",
}) => {
  ...
  const encodedTitle = encodeURIComponent(
    title || "Check out these amazing gift hampers from Shubhhampers!"
  );
  ...
  return (
    <div className={`social-share-buttons ${className}`}>
      <h3 className="text-lg font-semibold mb-4 text-gray-800">
        Share this amazing gift collection!
      </h3>
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        <h4 className="text-md font-medium mb-3 text-gray-700">
          Follow us for more amazing gifts!
        </h4>
        <div className="flex gap-3">
          ...
          <a
            href="https://www.linkedin.com/company/shubh-hampers"
            target="_blank"
            rel="noopener noreferrer"
          ...
          {/* <a
            href="https://www.facebook.com/shubhhampers"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://www.twitter.com/shubhhampers"
            target="_blank"
            rel="noopener noreferrer"
