          ...
          <nav aria-label='Main Navigation' className='hidden lg:flex flex-1 justify-center'>
            <ul className='flex space-x-3 items-center text-sm font-medium'>
              <li>
                <Link
                  href='/'
                  className='px-3 py-2 rounded-lg hover:bg-brand-gold/10 text-brand-brown'
                  aria-label='Home'
                >
                  Home
                </Link>
            ...
            <div className='hidden xl:flex items-center space-x-4 text-sm'>
              <div className='flex items-center space-x-2'>
                ...
                <div>
                  ...
                  <p className='font-semibold text-brand-brown'>+91 96858 47274</p>
                </div>
              </div>
            </div>
                ...
                <div className='py-6'>
                  ...
                  <nav className='space-y-6'>
                    ...
                    <div>
                      ...
                      <ul className='space-y-2 ml-6'>
                        <li>
                          <Link href='/about' className='text-gray-700 hover:text-brand-brown'>
                            Company History
                          </Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link href='/contact' className='text-gray-700 hover:text-brand-brown'>
                            General Inquiries
                          </Link>
                        </li>
                        <li>
