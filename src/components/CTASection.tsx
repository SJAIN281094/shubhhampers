...
export default function CTASection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-brand-brown via-brand-dark to-brand-brown relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-brand-dark/30 via-brand-brown/20 to-brand-dark/30"></div>

      {/* Authentic Floating Elements */}
      <div className="absolute top-10 left-10 w-40 h-40 bg-brand-gold/30 rounded-full blur-2xl animate-pulse"></div>
      <div className="absolute bottom-20 right-20 w-32 h-32 bg-brand-amber/40 rounded-full blur-xl animate-bounce"></div>
      <div className="absolute top-1/3 right-1/4 w-24 h-24 bg-brand-light/30 rounded-full blur-lg animate-pulse delay-300"></div>
      <div className="absolute bottom-1/3 left-1/4 w-20 h-20 bg-brand-gold/25 rounded-full blur-md animate-bounce delay-500"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <p className="text-xl lg:text-2xl text-brand-gold mb-8 leading-relaxed max-w-4xl mx-auto">
            We're passionate about helping you strengthen relationships through thoughtful gifting.
            Whether it's appreciating your team, celebrating with clients, or honoring traditions,
            we're here to make every gift moment special and meaningful.
          </p>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-brand-gold/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-brand-gold text-sm">
                  We're building lasting partnerships and learning from every interaction
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12">
            <p className="text-lg text-brand-gold mb-6">
              Ready to start your gifting journey? We'd love to hear from you and help create
