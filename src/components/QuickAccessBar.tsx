...
export default function QuickAccessBar() {
  ...
  const handleWhatsApp = () => {
    window.open(
      "https://wa.me/919685847274?text=Hello, I'm interested in your hamper services",
      "_blank"
    );
  };

  const handleCall = () => {
    window.open("tel:+919685847274", "_self");
  };

  const handleEmail = () => {
    window.open("mailto:connect@shubhhampers.com", "_self");
  };
