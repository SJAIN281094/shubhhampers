...
export default function SectionHeader({
  ...
  return (
    <div className={cn(variantStyles[variant], styles.spacing, "relative", className)}>
      {/* Decorative Elements */}
      {showDecorations && (
        <>
      ...
      <h2
        className={cn(
          "font-display font-bold mb-2 xs:mb-3 md:mb-4 leading-tight tracking-wide drop-shadow-sm relative z-10",
          styles.title,
          currentTheme.title
        )}
      >
      ...
      {description && (
        <p
          className={cn(
            "leading-relaxed mb-6 md:mb-8 px-4 md:px-0 font-normal drop-shadow-sm relative z-10",
            styles.description,
